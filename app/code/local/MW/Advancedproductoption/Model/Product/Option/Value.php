 ...
 */
class MW_Advancedproductoption_Model_Product_Option_Value extends Mage_Catalog_Model_Product_Option_Value
{
    ...
    {
        $collection = Mage::getResourceModel('advancedproductoption/product_option_value_collection')
