 ...
 */
class MW_Advancedproductoption_Model_Mysql4_Product_Option_Value extends Mage_Core_Model_Mysql4_Abstract
{
    protected function  _construct()
    {
        $this->_init('advancedproductoption/product_option_type_value', 'option_type_id');
    }

    protected function _afterSave(Mage_Core_Model_Abstract $object)
    {
        $priceTable = $this->getTable('advancedproductoption/product_option_type_price');
        $titleTable = $this->getTable('advancedproductoption/product_option_type_title');
    ...
    public function deleteValue($option_id)
    {
        ...
        $statement = $this->_getReadAdapter()->select()
            ->from($this->getTable('advancedproductoption/product_option_type_value'))
            ->where($condition);
    ...
    public function deleteValues($option_type_id)
    {
        ...
        $this->_getWriteAdapter()->delete(
            $this->getTable('advancedproductoption/product_option_type_price'),
            $childCondition
        );
        $this->_getWriteAdapter()->delete(
            $this->getTable('advancedproductoption/product_option_type_title'),
            $childCondition
        );
    }
    ...
    public function duplicate(Mage_Catalog_Model_Product_Option_Value $object, $oldOptionId, $newOptionId)
    {
        ...
        foreach ($valueCond as $oldTypeId => $newTypeId) {
            // price
            $table = $this->getTable('advancedproductoption/product_option_type_price');
            ...
            // title
            $table = $this->getTable('advancedproductoption/product_option_type_title');
            $sql = 'REPLACE INTO `' . $table . '` '
