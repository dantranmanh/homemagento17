 ...
 */
class MW_Advancedproductoption_Model_Mysql4_Product_Option_Collection
    extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    ...
    {
        $this->getSelect()
            ->joinLeft(array('default_option_price'=>$this->getTable('advancedproductoption/product_option_price')),
            ...
            ->joinLeft(array('store_option_price'=>$this->getTable('advancedproductoption/product_option_price')),
            ...
            ->join(array('default_option_title'=>$this->getTable('advancedproductoption/product_option_title')),
                '`default_option_title`.option_id=`main_table`.option_id',
                array('default_title'=>'title'))
            ->joinLeft(array('store_option_title'=>$this->getTable('advancedproductoption/product_option_title')),
    ...
    public function addValuesToResult($storeId = null)
    {
        ...
        if (!empty($optionIds)) {
            $values = Mage::getModel('advancedproductoption/product_option_value')
                ->getCollection()
