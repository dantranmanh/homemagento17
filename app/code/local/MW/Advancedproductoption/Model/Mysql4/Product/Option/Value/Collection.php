 ...
 */
class MW_Advancedproductoption_Model_Mysql4_Product_Option_Value_Collection
    extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    protected function _construct()
    {
        $this->_init('advancedproductoption/product_option_value');
    }

    public function getValues($store_id)
    {
        $this->getSelect()
            ->joinLeft(array('default_value_price'=>$this->getTable('advancedproductoption/product_option_type_price')),
            ...
            ->joinLeft(array('store_value_price'=>$this->getTable('advancedproductoption/product_option_type_price')),
            ...
            ->join(array('default_value_title'=>$this->getTable('advancedproductoption/product_option_type_title')),
                '`default_value_title`.option_type_id=`main_table`.option_type_id',
                array('default_title'=>'title'))
            ->joinLeft(array('store_value_title'=>$this->getTable('advancedproductoption/product_option_type_title')),
