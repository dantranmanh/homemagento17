 ...
 */
class MW_Advancedproductoption_Model_Mage_Adminhtml_System_Config_Source_Product_Options_Price
{
    public function toOptionArray()
    {
        return array(
            ...
            array('value' => 'onetime', 'label' => Mage::helper('adminhtml')->__('One Time')),
