 ...
 */
class MW_Advancedproductoption_Model_Mage_Product_Option_Type_Text extends MW_Advancedproductoption_Model_Mage_Product_Option_Type_Default
{
    /**
    ...
    public function validateUserValue($values)
    {
        ...
        if (strlen($value) == 0 && $option_require && !$this->getSkipCheckRequiredOption()) {
