 ...
 */
class MW_Advancedproductoption_Model_Mage_Product_Option_Type_File extends MW_Advancedproductoption_Model_Mage_Product_Option_Type_Default
{
    /**
    ...
    protected function _validateUploadedFile()
    {
        ...
        try {
            ...
            $runValidation = $option_require || $upload->isUploaded($file);
            if (!$runValidation) {
                $this->setUserValue(null);
                return $this;
            }
