 ...
 */
class MW_Advancedproductoption_Model_Mage_Product_Option_Type_Date extends MW_Advancedproductoption_Model_Mage_Product_Option_Type_Default
{
    /**
    ...
    public function validateUserValue($values)
    {
        ...
        } elseif (!$isValid && $option_require && !$this->getSkipCheckRequiredOption()) {
