...
class MW_Advancedproductoption_Block_Adminhtml_Catalog_Product_Edit_Tab_Options_Type_Select extends
    MW_Advancedproductoption_Block_Adminhtml_Catalog_Product_Edit_Tab_Options_Type_Abstract
{
    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('mw_advancedproductoption/mage/catalog/product/edit/options/type/select.phtml');
    }
