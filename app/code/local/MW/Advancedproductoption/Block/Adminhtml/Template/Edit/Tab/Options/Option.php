...
class MW_Advancedproductoption_Block_Adminhtml_Template_Edit_Tab_Options_Option extends Mage_Adminhtml_Block_Widget
{
    protected $_product;
    ...
    {
        parent::__construct();
        $this->setTemplate('mw_advancedproductoption/catalog/product/edit/options/option.phtml');
    }
    ...
    protected function _prepareLayout()
    {
        ...
        // them code vao
         $this->setChild('text_option_type',
            $this->getLayout()->createBlock('advancedproductoption/adminhtml_template_edit_tab_options_type_text')
        );
        $this->setChild('file_option_type',
            $this->getLayout()->createBlock('advancedproductoption/adminhtml_template_edit_tab_options_type_file')
        );
        $this->setChild('select_option_type',
            $this->getLayout()->createBlock('advancedproductoption/adminhtml_template_edit_tab_options_type_select')
        );
        $this->setChild('date_option_type',
            $this->getLayout()->createBlock('advancedproductoption/adminhtml_template_edit_tab_options_type_date')
        );
    ...
    public function getAddButtonId()
    {
        $buttonId = $this->getLayout()
                ->getBlock('template_custom_group')
    ...
    {
    	//$product = Mage::getSingleton('catalog/product')->load(165);
        //$optionsArr = array_reverse($product->getOptions(), true);
        $template_id = $this->getRequest()->getParam('id');
		$optionsArr = Mage::getResourceModel('advancedproductoption/product_option_collection')
												->getOptions(0) // store
												->addFieldToFilter('template_id',$template_id)
												->addValuesToResult(0); // store
	   //Mage::log($optionsArr);
